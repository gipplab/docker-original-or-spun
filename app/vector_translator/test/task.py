...
print("loading model")
model = gensim.models.Doc2Vec.load("C:/tmp/d2v-models/lc-models/MSSA2R/fxlc-c4-mssa2r-d2v.model")
print("model loaded")
...
rootpath= os.path.abspath("C:/Users/wgrosky/PycharmProjects/task_A/dataset")
...
for filename in filenames:
    ...
    for subdir, dirs, files in os.walk(os.path.join(rootpath, filename)):
        ...
        for file in files:
            ...
            inferred_vector = model.infer_vector(corpus, alpha=0.0001, min_alpha=0.000001, epochs=300)
